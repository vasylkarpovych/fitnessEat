...
function openModal(modalSelector, modalTimerId) {
  ...
  console.log(modalTimerId); // кожен раз як буде відкриватись модальне вікно, я буду дивитись на modalTimerId
  if (modalTimerId) {
...
/* harmony export */ });
// звичайно такі функціі (як postData) називають сервісами, та вимносять в окрему папку
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(".timer", "2024-08-31");
